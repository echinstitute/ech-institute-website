...
import {
  Users, Globe, Handshake, Network, MessageSquare,
...
const radarNodes = [
  ...
  { icon: Network,    title: 'Cross-Org Bridges',     desc: 'Establishing communication channels between previously siloed organizations for unified advocacy.' },
];
...
const partnerTypes = [
  ...
  { icon: Network,    title: 'Client Teams',            desc: 'Consensus and execution client developers who shape the technical direction of Ethereum.' },
];
