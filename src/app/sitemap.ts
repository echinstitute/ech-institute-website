...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}${ROUTES.education}`,   lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}${ROUTES.homestead}`,   lastModified: now, changeFrequency: "monthly", priority: 0.9 },
