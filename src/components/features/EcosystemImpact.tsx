...
function ImpactCard({ item }: { item: ImpactMetric }) {
  return (
    <article className="group flex min-h-0 w-full min-w-0 max-w-full flex-col rounded-[12px] border bg-[#1B1B1E] p-4 transition-all duration-200 border-[#262626] hover:border-[#F5A51D]/50">
      <div className="mb-3 flex min-w-0 items-start gap-3 sm:items-center">
        ...
        <h3 className="text-sm font-bold text-[#FBFBFB] min-w-0 flex-1 text-left leading-snug">
          {item.category}
        </h3>
      </div>

      <p className="mb-2 break-words text-lg font-bold tabular-nums tracking-tight text-[#F5A51D] sm:text-xl">
        {item.metric}
      </p>

      <p className="global-body mt-auto text-left text-[#FBFBFB]/60 break-words text-sm">
        {item.context}
      </p>
    </article>
  );
...
export function EcosystemImpact() {
  ...
  return (
    <section
      className="min-w-0 w-full max-w-full overflow-x-hidden rounded-[12px] border bg-[#1B1B1E] border-[#262626]"
    ...
    >
      <div className="px-4 py-5 border-b border-[#262626]">
        <div className="mx-auto w-full max-w-3xl text-center px-2">
          <p className="mb-2 flex flex-wrap items-center justify-center gap-2 global-body text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-[#FBFBFB]/50">
            <span className="flex h-7 w-7 sm:h-8 sm:w-8 shrink-0 items-center justify-center rounded-lg bg-[#262626]">
          ...
          <h2
            ...
            className="text-xl font-bold text-[#FBFBFB] text-balance break-words sm:text-2xl"
          >
            Ecosystem impact
          </h2>
          <p className="text-[#FBFBFB]/60 mx-auto max-w-2xl text-balance break-words text-xs sm:text-sm mt-2">
            Snapshot of what ECH Institute delivers through coordination, education, and media,
            updated <span className="font-medium text-[#FBFBFB]">February 2026</span>.
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto w-full max-w-md md:hidden">
          ...
          <div className="mt-4 flex items-center justify-center gap-3 px-1">
            <button
              ...
              className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#262626] bg-[#151419] text-[#FBFBFB] transition-colors hover:border-[#F5A51D] hover:bg-[#262626] active:scale-95"
