...
const members: Member[] = [
  {
    id: 1,
    name: "Pooja Ranjan",
    description: "Pooja Ranjan is Herder-in-chief at Ethereum Cat Herders supporting the Ethereum blockchain with project management & process improvement.",
...
export default function MembersSlider() {
  ...
  const calculateOffset = (index: number) => {
    ...
    return -(adjustedIndex * cardWithGap);
  };
  ...
  }, [isMounted, currentIndex, isPaused]);
  ...
  return (
    <div className="members-slider-section">
      ...
      <div className="members-slider-header">
        <h2 className="members-slider-title">Our Members</h2>
